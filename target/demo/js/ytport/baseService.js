...
function selectRoleDlg(opts){
    ...
    mini.open({
        url: "./security/sec_role.action?name=select",
        title: "选择角色",
        width: 900,
        height: 380,
        onload: function () {
...
function selectResourceDlg(opts){
    ...
    mini.open({
        url: "./security/sec_menu.action?name=select&autoCheckParent="+opts.autoCheckParent,
        title: "选择菜单",
        width: 900,
        height: 380,
        onload: function () {
...
function selectAuthDlg(opts){
    ...
    mini.open({
        url: "./security/sec_auth.action?name=select&autoCheckParent="+opts.autoCheckParent,
        title: "选择权限",
        width: 900,
        height: 380,
        onload: function () {
